...
export default function InputForm() {
  ...
  return (
    <section id="advisor" className="w-full min-h-screen bg-[#030303] py-32 relative overflow-hidden flex items-center justify-center">
      {/* Background lights */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-400 text-lg font-light leading-relaxed mb-8">
              Adjust the parameter inputs. Our neural synth engine will scan active specifications, verify performance ratios, and present 3 curated options matching your usage threshold.
            </p>

            {/* Micro Dashboard UI indicators to fit the tech-curator aesthetic */}
